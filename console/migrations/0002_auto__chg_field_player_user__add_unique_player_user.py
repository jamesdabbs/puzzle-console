...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('console_player', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Player', fields ['user']
        db.create_unique('console_player', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['user']
        db.delete_unique('console_player', ['user_id'])


        # Changing field 'Player.user'
        db.alter_column('console_player', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
