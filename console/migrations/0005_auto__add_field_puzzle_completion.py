...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Puzzle.completion'
        db.add_column('console_puzzle', 'completion',
                      self.gf('django.db.models.fields.CharField')(default='pr', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Puzzle.completion'
        db.delete_column('console_puzzle', 'completion')
