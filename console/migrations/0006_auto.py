...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field playtesters on 'Puzzle'
        db.create_table('console_puzzle_playtesters', (
        ...
        db.create_unique('console_puzzle_playtesters', ['puzzle_id', 'player_id'])


    def backwards(self, orm):
        # Removing M2M table for field playtesters on 'Puzzle'
        db.delete_table('console_puzzle_playtesters')
    ...
    models = {
        ...
        'console.puzzle': {
            ...
            'playtesters': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'puzzles_playtested'", 'symmetrical': 'False', 'to': "orm['console.Player']"}),
