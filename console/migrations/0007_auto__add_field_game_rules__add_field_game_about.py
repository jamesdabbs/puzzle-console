...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.rules'
        db.add_column('console_game', 'rules',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Game.about'
        db.add_column('console_game', 'about',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.rules'
        db.delete_column('console_game', 'rules')

        # Deleting field 'Game.about'
        db.delete_column('console_game', 'about')
