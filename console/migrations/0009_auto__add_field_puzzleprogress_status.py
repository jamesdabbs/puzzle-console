...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PuzzleProgress.status'
        db.add_column('console_puzzleprogress', 'status',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PuzzleProgress.status'
        db.delete_column('console_puzzleprogress', 'status')
