...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Puzzle.locked_description'
        db.add_column('console_puzzle', 'locked_description',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Puzzle.locked_description'
        db.delete_column('console_puzzle', 'locked_description')
