...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Puzzle.solution_location'
        db.add_column('console_puzzle', 'solution_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Puzzle.solution_location'
        db.delete_column('console_puzzle', 'solution_location')
