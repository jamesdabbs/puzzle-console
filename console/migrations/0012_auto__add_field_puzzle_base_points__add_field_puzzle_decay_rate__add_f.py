...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Puzzle.base_points'
        db.add_column('console_puzzle', 'base_points',
                      self.gf('django.db.models.fields.IntegerField')(default=500),
                      keep_default=False)

        # Adding field 'Puzzle.decay_rate'
        db.add_column('console_puzzle', 'decay_rate',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'Puzzle.hidden'
        db.add_column('console_puzzle', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Puzzle.base_points'
        db.delete_column('console_puzzle', 'base_points')

        # Deleting field 'Puzzle.decay_rate'
        db.delete_column('console_puzzle', 'decay_rate')

        # Deleting field 'Puzzle.hidden'
        db.delete_column('console_puzzle', 'hidden')
